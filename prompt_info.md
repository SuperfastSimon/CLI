# Prompt Log - 2025-12-14 21:05:27

**Model:** gpt-4o
**Type:** Python Script (Pure)
...
def ask_ai_brain():
    """Stel een snelle vraag aan GPT-4o voor code advies."""
    client = get_client()
    ...
    while True:
        ...
        try:
            response = client.chat.completions.create(
                model="gpt-4o", # Of gpt-4o-mini voor snelheid
                messages=[
